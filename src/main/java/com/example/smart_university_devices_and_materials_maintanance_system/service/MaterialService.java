...
public class MaterialService {
    ...
    public List<Material> getMyMaterials(Long userId) {
        return materialRepository.findByReportedById(userId != null ? userId : 0L);
    }
    ...
    @Transactional
    public Material updateMaterial(Long id, String materialName, String roomLocation, String description, String status) {
        Material material = materialRepository.findById(id != null ? id : 0L)
                .orElseThrow(() -> new IllegalArgumentException("Material not found"));
        material.setMaterialName(materialName);
        material.setRoomLocation(roomLocation);
        material.setDescription(description);
        material.setStatus(Material.MaterialStatus.valueOf(status));
        return materialRepository.save(material);
    }
