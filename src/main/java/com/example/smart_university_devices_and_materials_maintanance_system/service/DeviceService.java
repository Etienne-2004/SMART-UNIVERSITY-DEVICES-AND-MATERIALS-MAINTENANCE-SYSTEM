...
public class DeviceService {
    ...
    @Transactional
    public Device updateDevice(Long id, String deviceName, String deviceId, String roomLocation, String description, String status) {
        Device device = deviceRepository.findById(id != null ? id : 0L)
                .orElseThrow(() -> new IllegalArgumentException("Device not found"));
